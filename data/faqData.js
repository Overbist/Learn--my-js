// TS - https://hashdork.com/ru/top-typescript-interview-questions-and-answers/
...
export const faqData = [
  ...
  },
  {
    ...
    example: `
      ...
      // Version 4 - "JSON"
      // это быстрый и грязный способ глубокого клонирования объекта
      // работает только с литералом Number, String и Object без функции или свойства Symbol.
      JSON.parse(JSON.stringify(user))

      // Version 5 - "lodash utility library"
  ...
  },
  {
    ...
    answer: `HTMLCollection это динамическая HTML-коллекция которая представляет собой массивоподобный итерируемый объект дочерних элементов. 
  ...
  },
  {
    ...
    answer: `event.target – самый глубокий элемент, на котором произошло событие.
  ...
  },
  {
    ...
    answer: `Несмотря на то что синтаксис rest и spread одинаков это три точки в самом начале задачи которые они выполняют, диаметрально противоположные. 
  ...
  {
    category: "React",
    question: `Что возвращает хук useState при запуске?`,
    answer: `Этот хук возвращает массив из двух элементов, а вот дальше мы уже используем деструктуризацию для упрощения кода.`,
  },
]
